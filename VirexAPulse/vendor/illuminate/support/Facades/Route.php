 ...
 * @method static \Illuminate\Routing\Route group(array $attributes, \Closure|array|string $routes)
 ...
 * @method static \Illuminate\Routing\Route substituteImplicitBindingsUsing(callable $callback)
 * @method static void matched(string|callable $callback)
 * @method static array getMiddleware()
 * @method static \Illuminate\Routing\Route aliasMiddleware(string $name, string $class)
 * @method static bool hasMiddlewareGroup(string $name)
 * @method static array getMiddlewareGroups()
 * @method static \Illuminate\Routing\Route middlewareGroup(string $name, array $middleware)
 * @method static \Illuminate\Routing\Route prependMiddlewareToGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Route pushMiddlewareToGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Route removeMiddlewareFromGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Route flushMiddlewareGroups()
 ...
 * @method static \Illuminate\Routing\Route setContainer(\Illuminate\Container\Container $container)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static mixed macroCall(string $method, array $parameters)
 * @method static \Illuminate\Support\HigherOrderTapProxy|\Illuminate\Routing\Route tap(callable|null $callback = null)
