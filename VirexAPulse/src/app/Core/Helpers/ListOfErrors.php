...
class ListOfErrors
{
    ...
    public static function controllerNotFound($controller): string
    {
        return ErrorHandler::error(
            ...
            description: "Возможно контроллер не существует, либо его название или путь указаны неверно"
        );
    }
    ...
    {
        return ErrorHandler::error(
            "Метод $method не найден в классе $controller",
            description: "Возможно метод или путь/название класса указаны неверно"
        );
    }
    ...
    {
        return ErrorHandler::error(
            "Класс $class не найден!",
            description: "Возможно путь или имя класса указаны неверно 😵"
        );
    }
    ...
    {
        return ErrorHandler::error(
            "Эта страничка отправила $pageMethod, вместо $controllerMethod!",
    ...
    public static function failedHandlerResponse(): string
    {
        return ErrorHandler::error(
            ...
            description: "Произошла ошибка при вызове замыкания 0_0. Виновник - handler роутера! Возможная причина - var_dump() 🧐"
        );
    }
}