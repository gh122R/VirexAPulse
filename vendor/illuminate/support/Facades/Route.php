 ...
 * @method static \Illuminate\Routing\Nexus group(array $attributes, \Closure|array|string $routes)
 ...
 * @method static \Illuminate\Routing\Nexus substituteImplicitBindingsUsing(callable $callback)
 * @method static void matched(string|callable $callback)
 * @method static array getMiddleware()
 * @method static \Illuminate\Routing\Nexus aliasMiddleware(string $name, string $class)
 * @method static bool hasMiddlewareGroup(string $name)
 * @method static array getMiddlewareGroups()
 * @method static \Illuminate\Routing\Nexus middlewareGroup(string $name, array $middleware)
 * @method static \Illuminate\Routing\Nexus prependMiddlewareToGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Nexus pushMiddlewareToGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Nexus removeMiddlewareFromGroup(string $group, string $middleware)
 * @method static \Illuminate\Routing\Nexus flushMiddlewareGroups()
 ...
 * @method static \Illuminate\Routing\Nexus setContainer(\Illuminate\Container\Container $container)
 * @method static void macro(string $name, object|callable $macro)
 * @method static void mixin(object $mixin, bool $replace = true)
 * @method static bool hasMacro(string $name)
 * @method static void flushMacros()
 * @method static mixed macroCall(string $method, array $parameters)
 * @method static \Illuminate\Support\HigherOrderTapProxy|\Illuminate\Routing\Nexus tap(callable|null $callback = null)
